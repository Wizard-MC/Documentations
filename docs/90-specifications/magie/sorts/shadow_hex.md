# Hex d'Ombre — `shadow_hex`

> Projectile : faiblesse soft + dégâts légers.
...
*ils font foi dans `WizardCore/src/main/resources/spells.yml`, entrée `shadow_hex`.*
...
Projectile de malédiction : affaiblit plus qu'il ne blesse.
...
```text
/magicvfx test shadow_hex cast_start
/magicvfx test shadow_hex impact
```
