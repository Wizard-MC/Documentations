# Purge d'Esprit — `spirit_cleanse`

> Retire les effets négatifs (soi).
...
*ils font foi dans `WizardCore/src/main/resources/spells.yml`, entrée `spirit_cleanse`.*
...
| Tier de baguette | 1 |
| Temps d'incantation | 20 ticks (1 s) |
| Appris d'office | non — via le Grimoire |

## Intention

Purge les effets négatifs. Incantation assez longue pour qu'un adversaire puisse la couper.
...
| Concentration | `CAST_START` | `light_beam.bbmodel` | `spawn` | 1.3 s | CASTER_FEET | ENTITY_YAW | 2.2 bloc(s) |
...
```text
/magicvfx test spirit_cleanse cast_start
/magicvfx test spirit_cleanse impact
```
