# Brise de Tempête — `storm_breeze`

> Accélère brièvement vos déplacements.
...
*ils font foi dans `WizardCore/src/main/resources/spells.yml`, entrée `storm_breeze`.*
...
Accélération courte, sans cible. Sort de mobilité de tous les jours.
...
```text
/magicvfx test storm_breeze cast_start
/magicvfx test storm_breeze impact
```
