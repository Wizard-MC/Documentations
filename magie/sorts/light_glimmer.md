# Lueur d'Aurore — `light_glimmer`

> Éclaire les environs pendant 30 s.
...
*ils font foi dans `WizardCore/src/main/resources/spells.yml`, entrée `light_glimmer`.*
...
Le premier geste d'un apprenti : on lève la baguette et l'obscurité recule. Sort d'utilité pure, sans cible et sans risque, pensé pour être lancé en marchant. Son VFX reste discret — une lueur qui monte — pour ne pas gêner l'exploration.
...
```text
/magicvfx test light_glimmer cast_start
/magicvfx test light_glimmer impact
```
