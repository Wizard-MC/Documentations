# Lance de Sang — `blood_lance`

> Projectile soft plafonné (combat durci).
...
*ils font foi dans `WizardCore/src/main/resources/spells.yml`, entrée `blood_lance`.*
...
Projectile du Sang, plafonné comme tous les sorts de combat.
...
```text
/magicvfx test blood_lance cast_start
/magicvfx test blood_lance impact
```
