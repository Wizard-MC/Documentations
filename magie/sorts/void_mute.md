# Mute du Vide — `void_mute`

> Silence Magie soft + dégâts légers.
...
*ils font foi dans `WizardCore/src/main/resources/spells.yml`, entrée `void_mute`.*
...
Réduit au silence magique. Contre-sort du Vide, sans dégâts notables.
...
```text
/magicvfx test void_mute cast_start
/magicvfx test void_mute impact
```
